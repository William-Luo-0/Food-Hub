<?php
    ...
    $sql= "SELECT count(foodorder.OID) FROM foodorder WHERE CustomerUID=?";
    ...
    if (!mysqli_stmt_prepare($stmt, $sql)) {
        ...
        echo '<p>Total Orders: '.$result[0].'</p>';
    }
    ...
    if (isset($_GET["orderby"]) && isset($_GET["order"])) {
        ...
        if ($_GET["orderby"] == 'Name') {
            if ($_GET["order"] == 'ASC') {
                echo '<th scope="col"><a href="'.$redirect.'?orderby=Name&order=DESC#order-history">Restaurant <i class="fas fa-sort-up"></i></a></th>';
                $sql .= "ORDER BY Name DESC";
            } else if ($_GET["order"] == 'DESC') {
                echo '<th scope="col"><a href="'.$redirect.'?orderby=Name&order=ASC#order-history">Restaurant <i class="fas fa-sort-down"></i></a></th>';
                $sql .= "ORDER BY Name ASC";
            }
        } else {
            echo '<th scope="col"><a href="'.$redirect.'?orderby=Name&order=DESC#order-history">Restaurant</a></th>';
        }
        ...
        <tr>
            ...
            <th scope="col"><a href="'.$redirect.'?orderby=Name&order=DESC#order-history">Restaurant</a></th>
