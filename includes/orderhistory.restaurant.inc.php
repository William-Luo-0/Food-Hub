<?php
    ...
    $sql= "SELECT count(inventoryorder.OID) FROM inventoryorder WHERE RestaurantUID=?";
    ...
    $sql = "SELECT wholesaler.Name,
                    ...
                    WHERE inventoryorder.RestaurantUID=? ";
    if (isset($_GET["orderby"]) && isset($_GET["order"])) {
        ...
        if ($_GET["orderby"] == 'Name') {
            if ($_GET["order"] == 'ASC') {
                echo '<th scope="col"><a href="'.$redirect.'?orderby=Name&order=DESC#order-history">Wholesaler <i class="fas fa-sort-up"></i></a></th>';
                $sql .= "ORDER BY Name DESC";
            } else if ($_GET["order"] == 'DESC') {
                echo '<th scope="col"><a href="'.$redirect.'?orderby=Name&order=ASC#order-history">Wholesaler <i class="fas fa-sort-down"></i></a></th>';
                $sql .= "ORDER BY Name ASC";
            }
        } else {
            echo '<th scope="col"><a href="'.$redirect.'?orderby=Name&order=DESC#order-history">Wholesaler</a></th>';
        }
        ...
        echo '<table class="table" id="order-history">
            ...
            <tr>
                ...
                <th scope="col"><a href="'.$redirect.'?orderby=Name&order=DESC#order-history">Wholesaler</a></th>
